...
#print(type(text))
np.savetxt('combined_Random2.txt',
           combined_Random.values, fmt='%s', header='X') 

path_to_file = 'combined_Random2.txt'
...
array = []
array = (generate_text(model, start_string="whiterose1"))
print(array)
#print(generate_text(model, start_string="mimi12\n"))
'''
np.savetxt('array.csv', (  
                            array
                                  ), fmt='%s')
'''
result_data=pd.DataFrame(array)
result_data.to_csv('combined_random2.csv')
